import { LeadingPeriod, RecommendationProfile, ROSIDetail } from '@app/api-interfaces';
...
export class RecommendationService {
  ...
  private getROSI(rosiDetail: ROSIDetail): number {
    ...
    return Math.round(((rosiDetail.costOfIncident * rosiDetail.incidenceOccurrence * rosiDetail.mitigationRate) - investmentCost) / investmentCost);
  }
